...
const CommentInput: React.FC = () => {
  return (
    <form className="absolute left-[96px] top-[696px] w-[544px] h-60 pl-8 pr-12 py-8 bg-[#f3f5f8] text-[#949bad] border-t-2 border-[#e5eaf2] flex-col justify-start items-end gap-6 inline-flex">
        <textarea
